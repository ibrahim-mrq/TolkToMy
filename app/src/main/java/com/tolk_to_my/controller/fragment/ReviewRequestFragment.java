...
import com.tolk_to_my.databinding.FragmentReviewRequestBinding;
...
public class ReviewRequestFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {

    public ReviewRequestFragment() {
        // Required empty public constructor
    }

    public static ReviewRequestFragment newInstance() {
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentReviewRequestBinding.inflate(getLayoutInflater());
